...
public class ClientesBDTest {
		...
		public void testInsert() {
			...
			logica.datos.ClienteBaseDatos.insertCliente(basedatos.getConn(), "Aitor", "Pepito","Intxa","943212178","88877765O", domicilios);
			...
			for (Cliente c : visto) {
				...
				logica.datos.ClienteBaseDatos.insertCliente(basedatos.getConn(),"Aitor", "Pepito","Intxa",null,"88877765O", domicilios);
		...
		public void select() {
			...
			domicilios.add("Villa1");
			domicilios.add("Villa2");
			logica.datos.ClienteBaseDatos.insertCliente(basedatos.getConn(), "Aitor", "Matilla","Berio","645567543","73087432Q", domicilios);
			ArrayList<Cliente> visto = logica.datos.ClienteBaseDatos.selectAllCliente(basedatos.getConn());
			...
			logica.datos.ClienteBaseDatos.insertCliente(basedatos.getConn(), "Aitor", "Matilla","Berio",null,"73087432Q", domicilios);
			ArrayList<Cliente> visto1 = logica.datos.ClienteBaseDatos.selectAllCliente(basedatos.getConn());
		...
		public void delete() {
			...
			domicilios.add("Villa1");
			domicilios.add("Villa2");
			logica.datos.ClienteBaseDatos.insertCliente(basedatos.getConn(), "Pedro", "Martinez","Asuncion",null,"77766654P", domicilios);
			logica.datos.ClienteBaseDatos.delete(basedatos.getConn(), "71234567N");
			ArrayList<Cliente> leido = logica.datos.ClienteBaseDatos.selectAllCliente(basedatos.getConn());
